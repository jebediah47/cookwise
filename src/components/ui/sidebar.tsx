      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            side={side}
          >
             {/* This is to add an accessible name to the sheet for screen readers */}
...
function AnimatedHamburgerIcon({ open }: { open: boolean }) {
  return (
    <div className="relative h-5 w-5 transition-transform duration-300 ease-in-out">
      <span
        className={cn(
      ...
      <span
        className={cn(
          "absolute top-2 block h-0.5 w-full bg-current transition-all duration-300 ease-in-out",
